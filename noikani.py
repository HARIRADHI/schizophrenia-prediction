...
with open(r"C:\Users\user\Desktop\S88\app.css", "r") as f:
    css = f.read()
...
def main():
    ...
    alpha = col1.number_input("Enter the alpha value:",min_value=4.0,max_value=13.0, value=4.0)
    beta = col1.number_input("Enter the beta value:",min_value=12.0,max_value = 30.0, value=12.0)
    theta = col1.number_input("Enter the theta value:", min_value = 3.5,max_value = 9.5,value=7.5)
    delta = col1.number_input("Enter the delta value:", min_value = 0.5,max_value = 5.0,value=3.0)
